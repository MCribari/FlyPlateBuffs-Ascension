	...
	args = {
		...
		positionSettings = {
			...
			args = {
				...
				-- Options for lockouts and aoe
				break2 = {
					order = 14,
					type = "header",
					name = L["Special Features"] or "Special Features",
				},
				enableInterruptIcons = {
					order = 15,
					type = "toggle",
					name = L["Enable Interrupt Icons"] or "Enable Interrupt Icons",
					desc = L["Show an icon on enemy nameplates when they are interrupted (lockout)."] or "Show an icon on enemy nameplates when they are interrupted (lockout).",
					width = "full",
					get = function(info) 
						return db.enableInterruptIcons 
					end,
				...
				enableOpenIcons = {
					order = 16,
					type = "toggle",
					name = L["Enable Duration Icons"] or "Enable Duration Icons",
					desc = L["Show the duration of Flare and Consecration rank 1 on enemy nameplates when they are used. Also shows Water Elemental and Shadowfiend duration."] or "Show the duration of Flare, Consecration, Water Elemental and Shadowfiend.",
					width = "full",
					get = function(info) 
						return db.enableOpenIcons 
					end,
					set = function(info, val)
